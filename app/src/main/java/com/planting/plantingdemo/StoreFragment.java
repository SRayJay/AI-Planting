...
public class StoreFragment extends Fragment {
    ...
    private List<List<Plant_Classification>> plant_class_list_matrix = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Plant_Class_Adapter plant_class_adapter = new Plant_Class_Adapter(plant_class_list);
